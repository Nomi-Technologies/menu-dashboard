...
const Review = (props) => {
  ...
  const submitRegistration = () => {
    Client.registerRestaurant(registrationData.restaurantDetails).then(
      (response) => {
  ...
  return (
    <RegisterLayout>
      ...
      <FormSubtitle>
        Please review information before creating a restaurant page and gaining
      ...
      {registrationData ? (
        <>
          <InfoBox>
            ...
            <p>
              {registrationData.contactInfo.firstName}{" "}
              {registrationData.contactInfo.lastName}
            </p>
            <p>{registrationData.contactInfo.email}</p>
            <p>{registrationData.contactInfo.phone}</p>
          </InfoBox>
          <InfoBox>
            <p className="infoTitle">Restaurant Info</p>
            <p>{registrationData.restaurantDetails.name}</p>
            <p>{registrationData.restaurantDetails.streetAddress}</p>
            <p>
              {registrationData.restaurantDetails.city}{" "}
              {registrationData.restaurantDetails.state}{" "}
              {registrationData.restaurantDetails.zip}
            </p>
            <p>{registrationData.restaurantDetails.phone}</p>
            <p>{registrationData.restaurantDetails.yelp}</p>
          </InfoBox>
        </>
      ) : null}
      <FormControls>
