...
const RestaurantDetails = () => {
  ...
  return (
    <RegisterLayout>
      ...
      <FormSubtitle>
        Details about your restaurant's location and services
      </FormSubtitle>
      <FormRow>
        <FormInput
          width="100%"
      ...
      <FormRow>
        <FormInput
          ...
          value={restaurantDetails?.streetAddress}
        />
      </FormRow>
      <FormRow>
        <FormInput
      ...
      <FormRow>
        ...
        <FormInput
          width="49%"
          name="yelp-profile"
          placeholder="yelp profile (optional)"
          onChange={(event) => {
            setRestaurantDetails({
              ...restaurantDetails,
