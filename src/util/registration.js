...
export const setRegistrationData = (data) => {
    typeof window !== 'undefined' && localStorage.setItem('registrationData', JSON.stringify(data));
}


export const fetchRegistrationData = () => {
    const data = typeof window !== 'undefined' ? localStorage.getItem('registrationData') : null;
